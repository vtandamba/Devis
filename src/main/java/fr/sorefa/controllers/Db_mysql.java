 ...
 * @author  Alice Clochard/tanda
 * @version 4 (13 novembre 2020)
 */
...
public Db_mysql(String p_db_name, String login, String password, String p_sqlFile_create) throws Exception{	
   ...
   * @throws Exception        Exception levée si il y a une erreur (base non trouvée, erreur SQL)
   */
public Db_mysql(String p_db_name, String login, String password, String p_sqlFile_create, String p_sqlFile_init) throws Exception{	  
	try{
	  createBase(p_db_name+"?useTimezone=true&serverTimezone=UTC", login, password);			  
	  try{
		sqlExecFile(p_sqlFile_create);				
...
/**
   ...
   * 
   * @param p_table Nom de la table pour laquelle on veut connaître le dernier identifiant
